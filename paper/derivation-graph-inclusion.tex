...
$(R+1)$-clique level.  Padding that witness to every larger canonical level
$\mathbb C^n$ --- the final monotonicity step in the literal biconditional
\cref{eq:levels} --- is not formalized.  The concrete spaces $\cS_G$ and
...
compressed clique input with its exact expectation are formalized.
