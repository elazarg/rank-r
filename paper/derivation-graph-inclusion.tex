...
\Cref{lem:beta} and both halves of \cref{thm:clique} are machine-checked in the
...
Not formalized: \cref{prop:layers}, \cref{lem:dict}, \cref{lem:witness} and
\cref{thm:inclusion}, together with the operator systems $\cS_G$ and $\cU_G$ and
the free-spectrahedral dictionary they rest on.  Those restate \cref{thm:clique}
in matrix-convexity language and introduce no new constant.
