...
\texttt{Theta.lean}, \texttt{ThetaBound.lean}, \texttt{GraphLayers.lean} and
\texttt{GraphSpectrahedron.lean}.  The rook specialization and the
coefficient-space dimensions are checked in \texttt{GraphDimensions.lean} and
\texttt{RookGraph.lean}.  The basis-free positive-cone rendering of
