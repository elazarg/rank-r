...
The equal-dimension closed form \eqref{eq:Km}, its action on the distinguished
diagonal vector, its Hilbert--Schmidt norm, the attained ratio, and the strict
comparison with $1/4$ are machine-checked in finite coordinates.  The
eigenspace multiplicity count and the unequal-dimension embedding sentence are
not separately formalized, and the matching upper bound remains conjectural.
\end{remark}
