...
| positive-semidefinite shifted pullbacks and explicit energy baseline | **Open formalization** | positivity of individual pullbacks is standard matrix order; the channel completeness identity, minimum-eigenvalue shift, and displayed baseline have not been composed |
